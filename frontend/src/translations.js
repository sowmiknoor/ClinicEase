...
export const translations = {
  ...
  bn: {
    ...
    searchDoctor: "নাম বা বিশেষত্ব দিয়ে ডাক্তার খুঁজুন...",
    ...
    bookFirstAppointment: "একজন ডাক্তারের সাথে আপনার প্রথম অ্যাপয়েন্টমেন্ট বুক করুন",
    enterRejectionReason: "প্রত্যাখ্যানের কারণ লিখুন (ঐচ্ছিক):",
    rejectionReason: "প্রত্যাখ্যানের কারণ",
    completionNotes: "সম্পূর্ণতার নোট",
    anyAdditionalInfo: "কোন অতিরিক্ত তথ্য...",
    describeReasonForAppointment: "আপনার অ্যাপয়েন্টমেন্টের কারণ বর্ণনা করুন...",
    cancel: "বাতিল করুন",
    notes: "নোট",
